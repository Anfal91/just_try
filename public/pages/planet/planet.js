class App {
    constructor() {
        ...
        this.orbControls = new THREE.OrbitControls(this.camera, this.renderer.domElement);
        // Catch resize events
        window.onresize = (evt) => {
...
window.onload = function() {
    ...
    Terrain.fromImage('../textures/terrain.png')
    .then(function(terrain) {
        app.terrain = terrain;

        var loader = new THREE.TextureLoader();

        var texture = loader.load('../textures/rock-soil-surface.jpg', function() {
